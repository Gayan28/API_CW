 ...
 * @access  Private
 */
router.post('/add_location', protect, authorize('operator', 'admin'), addLocation);
 ...
 * @access  Public
 */
router.get('/get/:busId/latest', getLatestLocation);
 ...
 * @access  Public
 */
router.get('/get/latest/all', getAllLatest);
